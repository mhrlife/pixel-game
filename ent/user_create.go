...
func (uc *UserCreate) SetGameID(s string) *UserCreate {
...
func (uc *UserCreate) AddPixelIDs(ids ...int) *UserCreate {
	uc.mutation.AddPixelIDs(ids...)
	return uc
}

// AddPixels adds the "pixels" edges to the Pixel entity.
func (uc *UserCreate) AddPixels(p ...*Pixel) *UserCreate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.GameID(); !ok {
		return &ValidationError{Name: "game_id", err: errors.New(`ent: missing required field "User.game_id"`)}
	}
	return nil
}
